...
/* 	public async Task<bool> ValidateGameRBXL(Stream file, Models.Assets.Type assetType)
	...
	private static async Task SendCloseJobRequest(int port, string jobId)
	{
		...
		<SOAP-ENV:Envelope xmlns:SOAP-ENV=""http://schemas.xmlsoap.org/soap/envelope/"" 
						   ...
						   xmlns:ns2=""http://novarbx.cc/RCCServiceSoap"" 
						   xmlns:ns1=""http://novarbx.cc/"" 
						   xmlns:ns3=""http://novarbx.cc/RCCServiceSoap12"">
			<SOAP-ENV:Body>
				<ns1:CloseJob>
		...
		await SendSoapRequest(port, "http://novarbx.cc/CloseJob", XML);
	}
	...
	private async Task CreatePackageThumbnail(long assetId, CancellationToken? cancellationToken = null)
	{
		...
		try
		{
			var res = await SendSoapRequest(port, "http://novarbx.cc/OpenJob", XML);
			...
			NSManager.AddNamespace("ns1", "http://novarbx.cc/");
