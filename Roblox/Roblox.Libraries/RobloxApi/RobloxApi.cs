...
public class AssetDeliveryResponse
{
    ...
    // Added this from the Open Cloud script so GetProductInfoAssetDelivery can read it
    public Models.Assets.Type assetTypeId { get; set; } 
}
...
public class RobloxApi
{
    ...
    public async Task<Stream> GetAssetContent(long assetId, string openCloudApiKey)
    {
        ...
        {
            // Kept your original fallback logic from the second script just in case the Open Cloud logic fails entirely
