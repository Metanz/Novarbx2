...
local ChatRobloxEventReceiver = require(Modules.LuaChat.RobloxEventReceiver)
local ChatNotificationBroadcaster = require(Modules.LuaChat.NotificationBroadcaster)
...
function App:init()
	...
	ChatRobloxEventReceiver:init(self.state.store)
	self._chatNotificationBroadcaster = ChatNotificationBroadcaster.new(self.state.store)
